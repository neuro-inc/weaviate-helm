...
from apolo_apps_weaviate.types import WeaviateOutputs
...
class WeaviateOutputProcessor(BaseAppOutputsProcessor[WeaviateOutputs]):
    async def _generate_outputs(
        self,
        helm_values: dict[str, t.Any],
        app_instance_id: str,
    ) -> WeaviateOutputs:
        return await get_weaviate_outputs(helm_values, app_instance_id)
